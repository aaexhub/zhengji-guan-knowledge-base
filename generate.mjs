...
function showArticle(idx){document.getElementById('list-view').style.display='none';var dv=document.getElementById('detail-view');dv.innerHTML=detailHTML[idx];dv.style.display='block';window.scrollTo(0,0);markRead(idx)}
